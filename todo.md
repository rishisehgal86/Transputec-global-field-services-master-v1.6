...
- [x] Add timezone field to database
- [x] Create timezone utility functions for local/UTC conversion
- [x] Implement timezone detection from site coordinates (geo-tz library)
- [x] Update request form to show site timezone (not user timezone)
- [ ] Add dual timezone display (Local + UTC-0) to admin portal
- [ ] Add dual timezone display to engineer pages
- [ ] Add dual timezone display to client tracking page
- [ ] Add dual timezone display to audit logs
- [ ] Update all timestamp displays across the application

## Email Engineer Assignment
- [x] Create email template for engineer job assignment
- [x] Implement email sending functionality with job details
- [x] Include secure engineer link in assignment email
- [x] Update sendToEngineer endpoint with new email template
- [ ] Test email sending functionality

## Document Upload System
- [ ] Add document upload field to job creation form
- [x] Create job_documents table in database
- [x] Implement file upload to S3 storage
- [x] Create DocumentUpload and DocumentList components
- [x] Add document API endpoints
- [ ] Build document management UI for client tracking page
- [ ] Allow clients to upload additional documents after job creation
- [ ] Display uploaded documents on admin portal
- [ ] Display uploaded documents on engineer job page
- [ ] Add document upload events to audit logs
